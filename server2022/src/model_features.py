...
class Feature_gen:
    def __init__(self, max_lookback, min_lookback):
        ...
        self.positive_fin_feat = ['-4, Нематериальные активы, RUB',
       ...
       '-1, Внеоборотные активы, RUB', '-4, Оборотные активы, RUB',
       ...
       '-1, Капитал и резервы, RUB','-4, Выручка, RUB',
       ...
       '-1, Прибыль (убыток) от продажи, RUB',]
        ...
        self.negative_fin_feat = ['-4, Дебиторская задолженность, RUB',
       ...
       '-1, Краткосрочные обязательства, RUB',]
        ...
        self.abs_feat = self.positive_fin_feat + self.negative_fin_feat
